...
public class ExamplesTesterExtenxionDirs extends TestCase {
	static final Logger log = Logger.getLogger(ExamplesTesterExtenxionDirs.class);
	...
	static public void testExamples() throws Exception {
		...
		try {
			File examplesFolder=new File("examples-extension/");
